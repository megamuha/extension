...
namespace CodyDocs
{
    ...
    public sealed class CodyDocsPackage : AsyncPackage
    {
        ...
        /// </summary>
        public const string PackageGuidString = "14dd8540-7b29-4340-9135-3cd0d395cc4a";
        ...
        protected override async Task InitializeAsync(CancellationToken cancellationToken, IProgress<ServiceProgressData> progress)
        {
            ...
            await EnableCodyDocsCommand.InitializeAsync(this);
            await DisableCodyDocsCommand.InitializeAsync(this);
        }
